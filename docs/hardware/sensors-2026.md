...
>
> **Статус:** обзорный каталог. Конкретный выбор с тех пор уточнён практикой — ToF
> **VL53L7CX** (мультизонный, см. [vl53l7cx-best-practices.md](vl53l7cx-best-practices.md)) и
> курс на **MPU6050** (см. [orientation-and-mapping-decisions.md](orientation-and-mapping-decisions.md)).
